    ...
    var settings = {}, roots = {}, caches = {},
        ...
        _setting = {
            ...
            view: {
                ...
                //lyf 控制是否点击节点时展开/折叠节点
                isSelectedExpand:true,
                //lyf 控制是否禁止全部节点的点击动作触发
                allDisable:false,
                //lyf 控制是否单一路径展开
                isSinglePath:false,
                //lyf 控制是否在实现单一路径展开同时，控制取消所有节点选中状态
                isCancleCheck:false,
                curExpandNode:null
            },
            data: {
        ...
        init: function (obj, zSetting, zNodes) {
            ...
            var zTreeTools = {
                ...
                expandNode: function (node, expandFlag, sonSign, focus, callbackFlag) {
                    ...
                    var tid = node.tId;
                    var index = tid.lastIndexOf("_");
                    var treeid = tid.substr(0,index);
                    setting = settings[treeid];
