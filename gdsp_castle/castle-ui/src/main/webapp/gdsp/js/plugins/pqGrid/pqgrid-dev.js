...
(function($) {
	...
	fnPG._create = function() {
		...
		this.first = $("<button type='button' title='" + options.strFirstPage + "' class='ui-button ui-corner-all ui-widget ui-button-icon-only'><span class='ui-button-icon ui-icon ui-icon-seek-first'></span><span class='ui-button-icon-space'></span></button>", {}).appendTo(this.element).bind("click.paramquery", function(evt) {
		...
		this.prev = $("<button type='button' title='" + options.strPrevPage + "' class='ui-button ui-corner-all ui-widget ui-button-icon-only'><span class='ui-button-icon ui-icon ui-icon-seek-prev'></span><span class='ui-button-icon-space'></span></button>").appendTo(this.element).bind("click", function(evt) {
			if (that.options.curPage > 1) {
		...
		$("<span class='pq-separator'></span>").appendTo(this.element);
		this.next = $("<button type='button' title='" + this.options.strNextPage + "' class='ui-button ui-corner-all ui-widget ui-button-icon-only'><span class='ui-button-icon ui-icon ui-icon-seek-next'></span><span class='ui-button-icon-space'></span></button>").appendTo(this.element).bind("click", function(evt) {
		...
		this.last = $("<button type='button' title='" + this.options.strLastPage + "' class='ui-button ui-corner-all ui-widget ui-button-icon-only'><span class='ui-button-icon ui-icon ui-icon-seek-end'></span><span class='ui-button-icon-space'></span></button>").appendTo(this.element).bind("click", function(evt) {
		...
		this.$refresh = $("<button type='button' title='" + this.options.strRefresh + "' class='pqGrid-refresh ui-button ui-corner-all ui-widget ui-button-icon-only'><span class='ui-button-icon ui-icon ui-icon-arrowrefresh-1-w'></span><span class='ui-button-icon-space'></span>></button>").appendTo(this.element).bind("click", function(evt) {
	...
	fnPG._refresh = function() {
		...
		if (options.curPage === 1 ) {
			this.first.addClass('ui-button-disabled ui-state-disabled');
			this.prev.addClass('ui-button-disabled ui-state-disabled');
		} else {
			this.first.removeClass('ui-button-disabled ui-state-disabled');
			this.prev.removeClass('ui-button-disabled ui-state-disabled');
		}
		if (options.curPage === options.totalPages || options.totalPages === 0) {
			this.next.addClass('ui-button-disabled ui-state-disabled');
			this.last.addClass('ui-button-disabled ui-state-disabled');
		} else {
			this.next.removeClass('ui-button-disabled ui-state-disabled');
			this.last.removeClass('ui-button-disabled ui-state-disabled');
		} 
	...
	fn.remoteRequest = function(objP) {
		...
		if (typeof DM.getUrl == "function") {
			...
			if (typeof DM.url == "string") {
				...
				if (PM.type == "remote") {
					pageQueryString = {
						pageNum: PM.curPage>0?PM.curPage-1:PM.curPage,
						pageSize: PM.rPP
					}
				}
				var filterQS;
