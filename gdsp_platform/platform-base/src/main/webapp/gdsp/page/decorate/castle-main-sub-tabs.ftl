...
<div id="__castlePageContent" class="content-wrapper" style="padding-top:0px;padding-right:0px;">
    <#if __decorateContent?ends_with(".jsp")>
        <@include_page path="/page/"+__decorateContent/>
    <#else>
...
<script>
    ...
    if(node){
        node.style.minHeight = (window.innerHeight - 90) + "px";
    }
