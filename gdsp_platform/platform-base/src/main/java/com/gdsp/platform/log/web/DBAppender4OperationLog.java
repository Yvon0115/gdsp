...
public class DBAppender4OperationLog extends DBAppenderBase<ILoggingEvent> {

    protected String               insertSQL;
    protected static final Method  GET_GENERATED_KEYS_METHOD;
    static final StackTraceElement EMPTY_CALLER_DATA = CallerData.naInstance();
    private static final Logger logger = LoggerFactory.getLogger(DBAppender4OperationLog.class);
    static {
    ...
    @Override
    public void start() {
        insertSQL = "insert into tmp_cp_log_op(id,table_name,table_desc, createBy, service_id, data_id,type,createTime ) values("
                + "?,?,?,?,?,?,?,?)";
        super.start();
    }
    ...
    void bindLoggingEventArgumentsWithPreparedStatement(PreparedStatement stmt, Object[] argArray) throws SQLException {
        ...
        //因为这里的uuid在mybatis拦截器中维护，不需要在这里维护
        int index = 1;
