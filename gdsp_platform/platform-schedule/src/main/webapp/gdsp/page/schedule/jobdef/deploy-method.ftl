...
<@c.Box style="border-bottom:none;border-left:none;border-right:none;box-shadow:none;">
    <@c.BoxBody style="width:100%;min-height:330px; ">
	    ...
	    <@c.FormGroup id="expressionSet">
	    	<#-- validation={"required":false,"remote":"${ContextPath}/schedule/jobdef/cronExpressionCheck.d"} -->
       		<@c.FormInput name="expression" label="Cron表达式" validation={"cronCheck":true,"remote":"${ContextPath}/schedule/jobdef/cronExpressionCheck.d"} messages={"cronCheck":"不能为空！","remote":"Cron表达式错误！"} />
        </@c.FormGroup> 
	     
	    <@c.FormGroup id="period" label="有效期:">
        <@c.FormDate type="datetime" name="startTime" label="开始时间" value="" validation={"required":true}/>
        <@c.FormDate type="datetime" name="endTime" label="终止时间" value=""  validation={"compareTime":true} messages={"compareTime":"终止时间必须晚于开始时间!"}/>
       	</@c.FormGroup> 
   	</@c.BoxBody>
</@c.Box>