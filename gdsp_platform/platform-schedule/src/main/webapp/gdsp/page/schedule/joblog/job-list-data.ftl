...
<@c.SimpleTable striped=true titles=["任务类型","任务","开始时间", "结束时间","耗时(秒)","结果"] keys=["job_name","trigger_name","begintime","endtime","elapsedtime",result] ellipsis={"job_name":"175px","trigger_name":"175px"}  data=logPages.content checkbox=true/>
