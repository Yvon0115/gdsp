...
<@c.Box>
    <@c.BoxHeader class="border header-bg">
        <h3 class="box-title">部署任务类型</h3>
    </@c.BoxHeader>
    <@c.BoxBody>
    <@c.Form  id="deployForm" class="validate" action="${ContextPath}/schedule/jobdef/deployJob.d" method="post" before={"return checkDeployInf()":""} after={"switchtab":"#mainPanel","dataloader":"#jobdefsContent"}>
