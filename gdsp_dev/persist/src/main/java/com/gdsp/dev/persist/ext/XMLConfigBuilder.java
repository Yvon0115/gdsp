...
public class XMLConfigBuilder extends BaseBuilder {
     ...
     * 日志对象
     */
    private final static Log                  logger                         = LogFactory.getLog(XMLConfigBuilder.class);
    ...
    private void pluginElement(XNode parent) throws InstantiationException, IllegalAccessException{
        if (parent != null) {
            for (XNode child : parent.getChildren()) {
                ...
                if(interceptorInstance==null)return ;
    ...
    private void objectFactoryElement(XNode context) throws InstantiationException, IllegalAccessException{
        if (context != null) {
            ...
            factory = (ObjectFactory) resolveClass(type).newInstance();
    ...
    private void objectWrapperFactoryElement(XNode context) {
        if (context != null) {
            String type = context.getStringAttribute("type");
            ObjectWrapperFactory factory = null;
            try {
                factory = (ObjectWrapperFactory) resolveClass(type).newInstance();
    ...
    private void databaseIdProviderElement(XNode context) throws InstantiationException, IllegalAccessException, SQLException {
