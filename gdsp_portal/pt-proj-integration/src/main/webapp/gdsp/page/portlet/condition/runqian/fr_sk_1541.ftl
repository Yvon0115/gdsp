...
<@c.Condition id="queryCondition" target="#noiticeVos" action="${ContextPath}/plugins/date.d"  button=false class="pull-left" 
                                  style="width:780px;margin-left:-20px;height:35px;" labelsize=1 ctrlsize=3  parameter="parameter">
	<@c.FormGroup cols=3 >
		...
		<@c.FormComboBoxDict itemId="industry_div" type="industry_report" label="行业" name="industry"  itemStyle="display:none" value="" height="300">
		</@c.FormComboBoxDict>
