...
<modal-title>选择上级节点</modal-title>	
<@c.Box >	
     <@c.BoxBody class="no-padding scrollbar"  style="width:100%;max-height:500px;min-height:200px;">
			...
			<#-- <@c.SimpleTree id="dirTree" events="{clickNode: selectParentNode}">
			 ...
			 <@c.EasyTreeBuilder id="dirTree" events="{onNodeSelected:selectParentNode}"  url="/param/paramLibrary/queryParentTree.d" checkOption="1">
			</@c.EasyTreeBuilder>
	 </@c.BoxBody>
</@c.Box>
