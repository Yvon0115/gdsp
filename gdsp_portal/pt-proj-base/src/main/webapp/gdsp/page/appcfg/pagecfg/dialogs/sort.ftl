	...
	<@c.GRow>
		<@c.GCell cols=9>
			<div class="panel panel-default ">
				<div class=" scrollbar">
					<@c.Form id="sortForm" class="validate" action="${ContextPath}/appcfg/pagecfg/saveSort.d" method="post" after={"pagereload()":""}>
...
<div class="modal-footer">
	<@c.Button  type="submit"  icon="fa fa-save" action=[c.saveform("#sortForm")]>保存</@c.Button>
