	...
	<@c.GRow>
		<@c.GCell cols=9>
			<div class="panel panel-default">
				<div class=" scrollbar">
					<@c.Form id="sortForm" class="validate" action="${ContextPath}/widgetmgr/kpi/doSort.d" method="post" after={"dataloader":"#kpiName"}>
...
<div class="modal-footer">
	<@c.Button type="primary" click="submitSortForm()" icon="fa fa-save" action=[c.attrs({"data-dismiss":"modal"})]>保存</@c.Button>
