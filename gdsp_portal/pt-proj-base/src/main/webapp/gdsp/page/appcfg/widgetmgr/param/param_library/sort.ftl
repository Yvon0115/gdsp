	...
	<@c.GRow>
		<@c.GCell cols=9>
			<div class="panel panel-default">
				<div class=" scrollbar">
					<@c.Form id="sortForm" class="validate" action="${ContextPath}/portal/params_library/doSort.d" method="post" after={"dataloader":"#param_libContent"}>
...
<div class="modal-footer">
	<@c.Button type="primary" icon="fa fa-save" click="submitSortForm()"  action=[c.attrs({"data-dismiss":"modal"})]>保存</@c.Button>
